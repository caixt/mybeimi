...
public abstract class Board implements Message {
	 ...
	 * @return
	 */
	public abstract TakeCards takeCardsRequest(GameRoom gameRoom,Board board, Player player, boolean auto , byte[] playCards) ;
	 ...
	 * @param orgi
	 */
	public abstract void playcards(Board board , GameRoom gameRoom ,  Player player) ;
	/**
	 * 玩家出牌
	 * @param player
	 * @param cards
